...
function BtnMenu(props: { label?: string; icon?: BtnIcon; href?: string }) {
  const { label = "Button", icon = "memo", href = "#" } = props;
  ...
  return (
    ...
    >
      <span className={`${styles["btn-menu__icon"]} ${classIcon} mr-2`}></span>
